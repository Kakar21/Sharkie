...
let CHARACTER_IMAGES_LONG_IDLE = [
...
let CHARACTER_IMAGES_BUBBLETRAP = {
    NORMAL: [
...
let PUFFERFISH_IMAGES_PUFFING_UP = {
    GREEN: [
...
let PUFFERFISH_IMAGES_PUFFED_SWIM = {
    GREEN: [
